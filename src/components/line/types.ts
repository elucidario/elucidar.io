...
export type BaseLineProps<Attributes extends HTMLAttributes<any>> = Attributes &
...
export type CellProps<Attributes extends HTMLAttributes<any>> = Attributes &
    VariantProps<typeof yLineVariants> & {
        ref?: React.Ref<HTMLDivElement>;
        element?: HTMLElementType;
    };

export type LineProps<Attributes extends HTMLAttributes<any>> =
